...
/**
 * DebitConnectLoginParameters Class Doc Comment
 *
 * @category Class
 * @package  VOP\Rest
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class DebitConnectLoginParameters implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'DebitConnectLoginParameters';
...
'internal_id2' => 'int',
'token' => 'string',
'bonigateway' => '\VOP\Rest\Model\LoginParameters'    ];
...
'bonigateway' => 'getBonigateway'    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['bonigateway'] = isset($data['bonigateway']) ? $data['bonigateway'] : null;
    }
     ...
     * Sets internal_id1
     *
     * @param int $internal_id1 Username for api
     *
     * @return $this
     */
     ...
     * Sets internal_id2
     *
     * @param int $internal_id2 internalId2
     *
     * @return $this
     */
     ...
     * Gets bonigateway
     *
     * @return \VOP\Rest\Model\LoginParameters
     */
    public function getBonigateway()
    {
        return $this->container['bonigateway'];
    }

    /**
     * Sets bonigateway
     *
     * @param \VOP\Rest\Model\LoginParameters $bonigateway bonigateway
     *
     * @return $this
     */
    public function setBonigateway($bonigateway)
    {
        $this->container['bonigateway'] = $bonigateway;
